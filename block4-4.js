const pizzaPalace = {
  pizzas: ['Ultracheese', 'Smoked', 'Four meats'],
    order(pizzaName, onSuccess, onError) {
        if (this.pizzas.indexOf(pizzaName) >= 0) {
...
const result2 = pizzaPalace.order('Smoked', makePizza, onOrderError);
console.log(result2);
const result3 = pizzaPalace.order('Four meats', makePizza, onOrderError);
console.log(result3);
const result4 = pizzaPalace.order('Big Mike', makePizza, onOrderError);
console.log(result4);
const result5 = pizzaPalace.order('Vienna', makePizza, onOrderError);
console.log(result5);
